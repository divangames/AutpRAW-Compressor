...
Имя ZIP: `AutoRAWCompressor-0.0.1.17.ProtoAlpha.zip`. Настройки пользователя и `zona/data.dat` при обновлении сохраняются.
...
Строка версии: `X.Y.Z.W.Codename` (сейчас **0.0.1.17.ProtoAlpha**).
