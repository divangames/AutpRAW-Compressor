...
Имя ZIP должно содержать версию, например `AutoRAWCompressor-0.0.1.9.ProtoAlpha.zip`. Настройки (`ui_config.json`, `zona/data.dat`) сохраняются.
...
Строка версии: `X.Y.Z.W.Codename` (сейчас **0.0.1.9.ProtoAlpha**).
